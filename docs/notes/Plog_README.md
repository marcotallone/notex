...
- [Plog - portable, simple and extensible C++ logging library](#plog---portable-simple-and-extensible-c-logging-library)
...
- [Version history](#version-history)
  - [Version 1.1.11 (11 Aug 2025)](#version-1111-11-aug-2025)
  - [Version 1.1.10 (20 Aug 2023)](#version-1110-20-aug-2023)
  - [Version 1.1.9 (16 Dec 2022)](#version-119-16-dec-2022)
  - [Version 1.1.8 (10 Jun 2022)](#version-118-10-jun-2022)
  - [Version 1.1.7 (09 Jun 2022)](#version-117-09-jun-2022)
  - [Version 1.1.6 (06 Feb 2022)](#version-116-06-feb-2022)
  - [Version 1.1.5 (21 Oct 2019)](#version-115-21-oct-2019)
  - [Version 1.1.4 (26 Mar 2018)](#version-114-26-mar-2018)
  - [Version 1.1.3 (09 Aug 2017)](#version-113-09-aug-2017)
  - [Version 1.1.2 (02 May 2017)](#version-112-02-may-2017)
  - [Version 1.1.1 (17 Apr 2017)](#version-111-17-apr-2017)
  - [Version 1.1.0 (20 Nov 2016)](#version-110-20-nov-2016)
  - [Version 1.0.2 (19 Nov 2016)](#version-102-19-nov-2016)
  - [Version 1.0.1 (01 Nov 2015)](#version-101-01-nov-2015)
  - [Version 1.0.0 (19 May 2015)](#version-100-19-may-2015)
...
_Refer to [MultiAppender](samples/MultiAppender) for a complete sample._
...
_Refer to [MultiInstance](samples/MultiInstance) for a complete sample._
...
_Refer to [Shared](samples/Shared) for a complete sample._
...
_Important: don't forget to specify `PLOG_LOCAL` sharing mode on Linux/Unix systems for this sample._
...
_Refer to [Chained](samples/Chained) for a complete sample._
...
_See [Stream improvements over std::ostream](#stream-improvements-over-stdostream)._

_Refer to [Demo](samples/Demo) sample to see what can be written to the log stream._
...
_See [How to implement a custom formatter](#custom-formatter)._
...
_See [How to implement a custom converter](#custom-converter)._
...
_Refer to [NativeEOL](samples/NativeEOL) for a complete sample._
...
_See [How to implement a custom appender](#custom-appender)._
...
_Refer to [Arduino sample](samples/Arduino) for a complete sample._
...
_Refer to [DynamicAppender sample](samples/DynamicAppender) for a complete sample._
...
_Refer to [Performance](samples/Performance) for a complete sample._
...
_Define `PLOG_OMIT_LOG_DEFINES` before `#include <plog/Log.h>` or in the project settings!_
...
_Refer to [CustomType](samples/CustomType) for a complete sample._
...
_Refer to [CustomAppender](samples/CustomAppender) for a complete sample._
...
_Refer to [CustomFormatter](samples/CustomFormatter) for a complete sample._
...
_Refer to [CustomConverter](samples/CustomConverter) for a complete sample._
...
- New: Add support for UTF-8 char encoding on Windows (#76, #69, #238, #239)\
  _This allows to use [Utf8Everywhere](http://utf8everywhere.org) approach_
